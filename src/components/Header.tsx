...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* The wordmark used to live inside the hero photograph, so the header
          could stay hidden until the hero scrolled past. The hero is a plain
          photograph now, which would leave the first screen with no branding
          at all — so the header is simply always present. */}
      <header
        className={`site-header-ivory ${isProduct ? "site-header-product" : ""} sticky top-0 z-50 border-b backdrop-blur-sm`}
      >
        <div className="site-shell mx-auto grid h-16 max-w-7xl grid-cols-[1fr_auto_1fr] items-center px-4 sm:h-auto sm:px-6 sm:py-3 lg:px-8 lg:py-4">

...
export default function HeroCollectionLink() {
  ...
  return (
    <a href="#collection-title" className="home-hero-collection-link" onClick={handleClick}>
      <span className="home-hero-collection-label-mobile" lang="en" dir="ltr">SHOP DIAMONDS</span>
      <span className="home-hero-collection-label-desktop">לצפייה בקולקציה</span>
